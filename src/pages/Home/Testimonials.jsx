  ...
  return (
    <div>
      ...
      <p className="max-w-3xl mx-auto text-center mt-3 text-gray-800">
        This section showcases genuine testimonials and feedback from users,
        sharing their positive experiences to build trust and credibility with
        potential customers.
      </p>
      <div className="mt-12">
        <Swiper
        ...
        >
          ...
          <SwiperSlide>
            <div className="max-w-3xl mx-auto flex flex-col items-center gap-3 text-center py-12">
              ...
              <div className="flex items-center gap-3">
                <img src={client2} className="w-16" alt="" />
                <div>
                  <h3>Alex Johnson</h3>
                  <p>New York, USA</p>
                </div>
          ...
          <SwiperSlide>
            <div className="max-w-3xl mx-auto flex flex-col items-center gap-3 text-center py-12">
              ...
              <div className="flex items-center gap-3">
                <img src={client3} className="w-16" alt="" />
                <div>
                  <h3>Alex Johnson</h3>
                  <p>New York, USA</p>
                </div>
