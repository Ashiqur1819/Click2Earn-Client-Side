    ...
    <div className="lg:grid grid-cols-2 gap-3 items-center bg-white">
      ...
      <div className="p-4 md:p-6 lg:p-8">
        ...
        <div className="collapse collapse-arrow bg-gray-50 rounded-none mt-2">
          ...
          <div className="collapse-content">
            <p className="text-gray-600">
              Your earnings depend on the number and type of tasks you complete.
              Each task has a different payout based on its complexity.
            </p>
          </div>
        </div>
        <div className="collapse collapse-arrow bg-gray-50 rounded-none mt-2">
          ...
          <div className="collapse-content">
            <p className="text-gray-600">
              Payments are processed within 3-5 business days after reaching the
        ...
        <div className="collapse collapse-arrow bg-gray-50 rounded-none mt-2">
          ...
          <div className="collapse-content">
            <p className="text-gray-600">
              Yes, we prioritize your privacy and use advanced security measures
